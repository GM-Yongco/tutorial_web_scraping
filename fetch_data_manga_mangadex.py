...
def fetch_data_mangadex_feed(
	...
	ret_val += f"Title: Chapter {int(response_formatted['attributes']['chapter']):03} {response_formatted['attributes']['title']}"
	ret_val += "\n"
	ret_val += f"Link: https://mangadex.org/chapter/{response_formatted['id']}"
	
	return ret_val

def fetch_data_tgswiiwagaa()->str:
	return fetch_data_mangadex_feed()